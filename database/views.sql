...
AS
    SELECT microfinances.id,microfinances.name,microfinances.email,loans.id AS 'loan_id',loans.user_id,loans.type,loans.amount,loans.repayment_period,loans.status,loans.guarantor_details FROM loans
